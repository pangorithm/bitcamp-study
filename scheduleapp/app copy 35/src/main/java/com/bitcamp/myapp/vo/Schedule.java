...
public class Schedule implements Serializable, CsvObject, AutoIncrement {
  ...
  public void updateKey() {
    if (this.no > Schedule.scheduleId) {
      Schedule.scheduleId = this.no + 1;
    }
  }
  ...
  public static Schedule fromCsv(String csv) {
    ...
    if (Schedule.scheduleId <= schedule.getNo()) {
      Schedule.scheduleId = schedule.getNo() + 1;
    }
    return schedule;
  }
