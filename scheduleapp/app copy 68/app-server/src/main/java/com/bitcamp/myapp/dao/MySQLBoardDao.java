...
public class MySQLBoardDao implements BoardDao {
  ...
  public int insertFiles(Board board) {
    SqlSession sqlSession = sqlSessionFactory.openSession(false);
    return sqlSession.insert("com.bitcamp.myapp.dao.BoardDao.insertFiles", board);
  }

  @Override
  public AttachedFile findFileBy(int no) {
    SqlSession sqlSession = sqlSessionFactory.openSession(false);
    return sqlSession.selectOne("com.bitcamp.myapp.dao.BoardDao.findFileBy", no);
  }

  @Override
  public int deleteFile(int fileNo) {
    SqlSession sqlSession = sqlSessionFactory.openSession(false);
    return sqlSession.delete("com.bitcamp.myapp.dao.BoardDao.deleteFile", fileNo);
  }

  @Override
  public int deleteFiles(int boardNo) {
    SqlSession sqlSession = sqlSessionFactory.openSession(false);
    return sqlSession.delete("com.bitcamp.myapp.dao.BoardDao.deleteFiles", boardNo);
  }
