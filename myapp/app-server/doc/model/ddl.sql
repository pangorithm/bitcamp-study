...
CREATE TABLE edu_student (
  ...
  basic_adress  VARCHAR(255) NOT NULL COMMENT '기본주소', -- 기본주소
  detail_adress VARCHAR(255) NULL     COMMENT '상세주소', -- 상세주소
...
CREATE TABLE edu_teacher (
  ...
  etno   INTEGER     NULL     COMMENT '고용형태', -- 고용형태
...
CREATE TABLE edu_employ_type (
  ...
  title VARCHAR(50) NULL     COMMENT '고용형태명' -- 고용형태명
)
COMMENT '고용형태';
