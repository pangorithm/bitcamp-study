...
import bitcamp.myapp.controller.BoardAddController;
import bitcamp.myapp.controller.BoardDeleteController;
import bitcamp.myapp.controller.BoardDetailController;
...
import bitcamp.myapp.controller.MemberAddController;
import bitcamp.myapp.controller.MemberDeleteController;
import bitcamp.myapp.controller.MemberDetailController;
import bitcamp.myapp.controller.MemberListController;
import bitcamp.myapp.controller.MemberUpdateController;
...
public class DispatcherServlet extends HttpServlet {
  ...
  public void init() throws ServletException {
    ...
    controllerMap.put("/member/detail",
        new MemberDetailController(memberDao));
    controllerMap.put("/member/update",
        new MemberUpdateController(memberDao, sqlSessionFactory, ncpObjectStorageService));
    controllerMap.put("/member/delete",
        new MemberDeleteController(memberDao, sqlSessionFactory));

    controllerMap.put("/board/list",
    ...
    controllerMap.put("/board/detail",
        new BoardDetailController(boardDao, sqlSessionFactory));
    ...
    controllerMap.put("/board/delete",
        new BoardDeleteController(boardDao, sqlSessionFactory));
